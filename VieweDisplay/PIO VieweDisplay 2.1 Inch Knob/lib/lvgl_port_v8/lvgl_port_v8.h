...
// Pull in esp-utils checks via the library umbrella header
#include <esp_lib_utils.h>

// Map ESP Panel check macros to esp-utils equivalents if not provided by the panel library
#ifndef ESP_PANEL_CHECK_FALSE_RET
#define ESP_PANEL_CHECK_FALSE_RET ESP_UTILS_CHECK_FALSE_RETURN
#endif
#ifndef ESP_PANEL_CHECK_NULL_RET
#define ESP_PANEL_CHECK_NULL_RET ESP_UTILS_CHECK_NULL_RETURN
#endif
#ifndef ESP_PANEL_CHECK_ERR_RET
#define ESP_PANEL_CHECK_ERR_RET ESP_UTILS_CHECK_ERROR_RETURN
#endif

// Provide defaults if board config didn't define these legacy macros
