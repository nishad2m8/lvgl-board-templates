...
#define LV_MEM_CUSTOM 0
    ...
    #define LV_MEM_SIZE (160U * 1024U)          /*[bytes] - 增加到160KB以支持GIF动画*/
...
#define LV_MEM_BUF_MAX_NUM 32  /* 增加缓冲区数量以支持GIF动画 */
...
#define LV_DISP_DEF_REFR_PERIOD 16      /*[ms] - 降低刷新周期以提高动画流畅度（约60fps）*/
...
#define LV_TICK_CUSTOM 1  /* 启用自定义tick源，使用millis()自动更新 */
#if LV_TICK_CUSTOM
 ...
 *0: to disable caching*/
#define LV_IMG_CACHE_DEF_SIZE 1  /* 启用图像缓存以支持GIF动画 */
