...
static const uint8_t gc9a01_init_operations[] = {
    ...
    WRITE_C8_D8, 0x8D, 0x03,

    // WRITE_COMMAND_8, 0xB5,
    // WRITE_BYTES, 4, 0x08, 0x09, 0x14, 0x08,

    WRITE_COMMAND_8, 0xB6,
    WRITE_BYTES, 2, 0x00, 0x00,

    WRITE_C8_D8, 0x36, 0x48, //有变化
    ...
    WRITE_C8_D8, 0xC3, 0x1F,  //
    WRITE_C8_D8, 0xC4, 0x1F, //

    WRITE_C8_D8, 0xC9, 0x25,
    ...
    // WRITE_COMMAND_8, 0x8D,
    // WRITE_BYTES, 1,
    // 0x03,

    WRITE_C8_D16, 0x98, 0x3e, 0x07,

    WRITE_C8_D16, 0x99, 0x3e, 0x07,
